...
function verPostsUsuario(idUsuario) {
  ...
  var listaPosts = consultarListaPostsUsuario(idUsuario, function (datos) {
    ...
    for (var i = 0; i < datos.length; i++) {
      ...
      var textDiv = document.createTextNode(JSON.stringify(datos[i].title + " " + datos[i].idg));
